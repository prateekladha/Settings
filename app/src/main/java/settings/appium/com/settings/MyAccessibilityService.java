...
public class MyAccessibilityService extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (eventType == AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED) {
            ...
            if (parcelable instanceof Notification) {
                ...
                if (messages.size() > 0) {
                    final String notificationMsg = String.valueOf(messages.get(0));
                ...
                List<CharSequence> messages = event.getText();
                if (messages.size() > 0) {
                    final String toastMsg = String.valueOf(messages.get(0));
    ...
    public static final class Constants {
        ...
        public static final String ACTION_CATCH_TOAST = "settings.appium.com.settings.CATCH_TOAST";
        public static final String ACTION_CATCH_NOTIFICATION = "settings.appium.com.settings.CATCH_NOTIFICATION";
    }
    ...
    public static boolean isAccessibilitySettingsOn(Context mContext) {
        ...
        final String service = "settings.appium.com.settings/settings.appium.com.settings.MyAccessibilityService";

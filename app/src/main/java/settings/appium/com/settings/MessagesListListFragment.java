 ...
 * currently being viewed in a {@link MessagesListDetailFragment}.
 * <p/>
 * Activities containing this fragment MUST implement the {@link Callbacks}
 * interface.
 */
public class MessagesListListFragment extends ListFragment {
     ...
     */
    public MessagesListListFragment() {
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setListAdapter(new ArrayAdapter<MessageContent.MessageItem>(
                getActivity(),
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(MessageContent.ITEMS.get(position).id);
    }
